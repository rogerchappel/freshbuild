# Agent Operating Instructions for freshbuild

This file defines how AI agents and human maintainers should work in `freshbuild`.

## Project Context

- Project: `freshbuild`
- Repository: `https://github.com/rogerchappel/freshbuild`
- Primary maintainer: ``
- Default branch: `main`
- Package manager: `npm`
